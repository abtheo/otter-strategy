...
export class DeprecatedClamPlus extends ethereum.SmartContract {
  static bind(address: Address): DeprecatedClamPlus {
    return new DeprecatedClamPlus("DeprecatedClamPlus", address);
  }
