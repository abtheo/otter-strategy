...
export class GainsDaiStrategy extends ethereum.SmartContract {
  static bind(address: Address): GainsDaiStrategy {
    return new GainsDaiStrategy("GainsDaiStrategy", address);
  }
  ...
  SWAP_SLIPPAGE_BP(): BigInt {
    let result = super.call(
      "SWAP_SLIPPAGE_BP",
      "SWAP_SLIPPAGE_BP():(uint256)",
      []
    );
  ...
  try_SWAP_SLIPPAGE_BP(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "SWAP_SLIPPAGE_BP",
      "SWAP_SLIPPAGE_BP():(uint256)",
      []
