...
export class MaiStMaticStrategy extends ethereum.SmartContract {
  static bind(address: Address): MaiStMaticStrategy {
    return new MaiStMaticStrategy("MaiStMaticStrategy", address);
  }
  ...
  gUniRouter(): Address {
    let result = super.call("gUniRouter", "gUniRouter():(address)", []);

    return result[0].toAddress();
  }

  try_gUniRouter(): ethereum.CallResult<Address> {
    let result = super.tryCall("gUniRouter", "gUniRouter():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  lpMaiStMatic(): Address {
    let result = super.call("lpMaiStMatic", "lpMaiStMatic():(address)", []);

    return result[0].toAddress();
  }

  try_lpMaiStMatic(): ethereum.CallResult<Address> {
    let result = super.tryCall("lpMaiStMatic", "lpMaiStMatic():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
