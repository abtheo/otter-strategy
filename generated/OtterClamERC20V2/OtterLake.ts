...
export class TermUpdated extends ethereum.Event {
  get params(): TermUpdated__Params {
    return new TermUpdated__Params(this);
  }
}

export class TermUpdated__Params {
  _event: TermUpdated;

  constructor(event: TermUpdated) {
    this._event = event;
  }
...
export class SetTermCall extends ethereum.Call {
  get inputs(): SetTermCall__Inputs {
    return new SetTermCall__Inputs(this);
  }

  get outputs(): SetTermCall__Outputs {
    return new SetTermCall__Outputs(this);
  }
}

export class SetTermCall__Inputs {
  _call: SetTermCall;

  constructor(call: SetTermCall) {
    this._call = call;
  }
...
export class SetTermCall__Outputs {
  _call: SetTermCall;
