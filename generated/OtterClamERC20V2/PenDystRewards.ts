...
export class PenDystRewards__rewardDataResult {
  value0: Address;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class PenDystRewards extends ethereum.SmartContract {
  static bind(address: Address): PenDystRewards {
    return new PenDystRewards("PenDystRewards", address);
  }
  ...
  rewardData(param0: Address): PenDystRewards__rewardDataResult {
    let result = super.call(
      "rewardData",
    ...
    return new PenDystRewards__rewardDataResult(
      result[0].toAddress(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_rewardData(
    param0: Address
  ): ethereum.CallResult<PenDystRewards__rewardDataResult> {
    let result = super.tryCall(
      "rewardData",
      "rewardData(address):(address,uint256,uint256,uint256,uint256,uint256)",
      [ethereum.Value.fromAddress(param0)]
    ...
    return ethereum.CallResult.fromValue(
      new PenDystRewards__rewardDataResult(
        value[0].toAddress(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
