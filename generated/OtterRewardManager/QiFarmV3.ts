...
export class QiFarmV3__poolInfoResult {
  value0: Address;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class QiFarmV3__userInfoResult {
  value0: BigInt;
  value1: BigInt;
...
export class QiFarmV3 extends ethereum.SmartContract {
  static bind(address: Address): QiFarmV3 {
    return new QiFarmV3("QiFarmV3", address);
  }
  ...
  poolInfo(param0: BigInt): QiFarmV3__poolInfoResult {
    let result = super.call(
      "poolInfo",
    ...
    return new QiFarmV3__poolInfoResult(
      result[0].toAddress(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_poolInfo(param0: BigInt): ethereum.CallResult<QiFarmV3__poolInfoResult> {
    let result = super.tryCall(
      "poolInfo",
      "poolInfo(uint256):(address,uint256,uint256,uint256,uint16)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
  ...
  userInfo(param0: BigInt, param1: Address): QiFarmV3__userInfoResult {
    let result = super.call(
      "userInfo",
    ...
    return new QiFarmV3__userInfoResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_userInfo(
    param0: BigInt,
    param1: Address
  ): ethereum.CallResult<QiFarmV3__userInfoResult> {
    let result = super.tryCall(
      "userInfo",
      "userInfo(uint256,address):(uint256,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new QiFarmV3__userInfoResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
}
...
export class UpdatePoolDepositFeeCall extends ethereum.Call {
  get inputs(): UpdatePoolDepositFeeCall__Inputs {
    return new UpdatePoolDepositFeeCall__Inputs(this);
  }

  get outputs(): UpdatePoolDepositFeeCall__Outputs {
    return new UpdatePoolDepositFeeCall__Outputs(this);
  }
}

export class UpdatePoolDepositFeeCall__Inputs {
  _call: UpdatePoolDepositFeeCall;

  constructor(call: UpdatePoolDepositFeeCall) {
    this._call = call;
  }
...
export class UpdatePoolDepositFeeCall__Outputs {
  _call: UpdatePoolDepositFeeCall;
