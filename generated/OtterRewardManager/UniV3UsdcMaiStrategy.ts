...
export class UniV3UsdcMaiStrategy__getDeltaResultDeltaStruct extends ethereum.Tuple {
  get currentTick(): i32 {
    return this[0].toI32();
  }
  ...
  get deltaUsdc(): BigInt {
    return this[7].toBigInt();
  }
}

export class UniV3UsdcMaiStrategy__lpPosResult {
  value0: i32;
  value1: i32;
  value2: BigInt;
  value3: BigInt;
...
export class UniV3UsdcMaiStrategy__pendingRewardsResult {
  value0: BigInt;
  value1: BigInt;
...
export class UniV3UsdcMaiStrategy__underlyingAssetsResultAssetsStruct extends ethereum.Tuple {
  get usdcBalance(): BigInt {
    return this[0].toBigInt();
  }

  get maiBalance(): BigInt {
    return this[1].toBigInt();
  }

  get maiBalanceUsdc(): BigInt {
  ...
  get maiFeeUsdc(): BigInt {
    return this[8].toBigInt();
  }
}

export class UniV3UsdcMaiStrategy extends ethereum.SmartContract {
  static bind(address: Address): UniV3UsdcMaiStrategy {
    return new UniV3UsdcMaiStrategy("UniV3UsdcMaiStrategy", address);
  }
  ...
  getDelta(): UniV3UsdcMaiStrategy__getDeltaResultDeltaStruct {
    let result = super.call(
      "getDelta",
      "getDelta():((int24,uint160,int24,uint160,int24,uint160,bool,int256))",
      []
    );

    return changetype<UniV3UsdcMaiStrategy__getDeltaResultDeltaStruct>(
      result[0].toTuple()
    );
  }

  try_getDelta(): ethereum.CallResult<
    UniV3UsdcMaiStrategy__getDeltaResultDeltaStruct
  > {
    let result = super.tryCall(
      "getDelta",
      "getDelta():((int24,uint160,int24,uint160,int24,uint160,bool,int256))",
    ...
    return ethereum.CallResult.fromValue(
      changetype<UniV3UsdcMaiStrategy__getDeltaResultDeltaStruct>(
        value[0].toTuple()
      )
    );
  }
  ...
  lpPos(): UniV3UsdcMaiStrategy__lpPosResult {
    let result = super.call(
      "lpPos",
      "lpPos():(int24,int24,uint128,uint128,uint128)",
      []
    );

    return new UniV3UsdcMaiStrategy__lpPosResult(
      result[0].toI32(),
      result[1].toI32(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_lpPos(): ethereum.CallResult<UniV3UsdcMaiStrategy__lpPosResult> {
    let result = super.tryCall(
      "lpPos",
      "lpPos():(int24,int24,uint128,uint128,uint128)",
      []
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new UniV3UsdcMaiStrategy__lpPosResult(
        value[0].toI32(),
        value[1].toI32(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  pendingRewards(): UniV3UsdcMaiStrategy__pendingRewardsResult {
    let result = super.call(
      "pendingRewards",
    ...
    return new UniV3UsdcMaiStrategy__pendingRewardsResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }

  try_pendingRewards(): ethereum.CallResult<
    UniV3UsdcMaiStrategy__pendingRewardsResult
  > {
    let result = super.tryCall(
      "pendingRewards",
      "pendingRewards():(uint256,uint256)",
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new UniV3UsdcMaiStrategy__pendingRewardsResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  underlyingAssets(): UniV3UsdcMaiStrategy__underlyingAssetsResultAssetsStruct {
    let result = super.call(
      "underlyingAssets",
    ...
    return changetype<UniV3UsdcMaiStrategy__underlyingAssetsResultAssetsStruct>(
      result[0].toTuple()
    );
  }

  try_underlyingAssets(): ethereum.CallResult<
    UniV3UsdcMaiStrategy__underlyingAssetsResultAssetsStruct
  > {
    let result = super.tryCall(
      "underlyingAssets",
      "underlyingAssets():((uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256))",
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      changetype<UniV3UsdcMaiStrategy__underlyingAssetsResultAssetsStruct>(
        value[0].toTuple()
      )
    );
  }
...
export class SetTicksCall extends ethereum.Call {
  get inputs(): SetTicksCall__Inputs {
    return new SetTicksCall__Inputs(this);
  }

  get outputs(): SetTicksCall__Outputs {
    return new SetTicksCall__Outputs(this);
  }
}

export class SetTicksCall__Inputs {
  _call: SetTicksCall;

  constructor(call: SetTicksCall) {
    this._call = call;
  }
...
export class SetTicksCall__Outputs {
  _call: SetTicksCall;
