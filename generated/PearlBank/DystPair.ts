...
export class Treasury extends ethereum.Event {
  get params(): Treasury__Params {
    return new Treasury__Params(this);
  }
}

export class Treasury__Params {
  _event: Treasury;

  constructor(event: Treasury) {
    this._event = event;
  }
...
export class DystPair__burnResult {
  value0: BigInt;
  value1: BigInt;
...
export class DystPair__claimFeesResult {
  value0: BigInt;
  value1: BigInt;
...
export class DystPair__currentCumulativePricesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class DystPair__getReservesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class DystPair__lastObservationResultValue0Struct extends ethereum.Tuple {
...
export class DystPair__metadataResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class DystPair__observationsResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class DystPair__tokensResult {
  value0: Address;
  value1: Address;
...
export class DystPair extends ethereum.SmartContract {
  static bind(address: Address): DystPair {
    return new DystPair("DystPair", address);
  }
  ...
  burn(to: Address): DystPair__burnResult {
    let result = super.call("burn", "burn(address):(uint256,uint256)", [
      ethereum.Value.fromAddress(to)
    ]);

    return new DystPair__burnResult(result[0].toBigInt(), result[1].toBigInt());
  }

  try_burn(to: Address): ethereum.CallResult<DystPair__burnResult> {
    ...
    return ethereum.CallResult.fromValue(
      new DystPair__burnResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
  ...
  claimFees(): DystPair__claimFeesResult {
    let result = super.call("claimFees", "claimFees():(uint256,uint256)", []);

    return new DystPair__claimFeesResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }

  try_claimFees(): ethereum.CallResult<DystPair__claimFeesResult> {
    let result = super.tryCall(
      "claimFees",
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new DystPair__claimFeesResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
  ...
  currentCumulativePrices(): DystPair__currentCumulativePricesResult {
    let result = super.call(
    ...
    return new DystPair__currentCumulativePricesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_currentCumulativePrices(): ethereum.CallResult<
    DystPair__currentCumulativePricesResult
  > {
    let result = super.tryCall(
      "currentCumulativePrices",
      "currentCumulativePrices():(uint256,uint256,uint256)",
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new DystPair__currentCumulativePricesResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
  ...
  getReserves(): DystPair__getReservesResult {
    let result = super.call(
      "getReserves",
    ...
    return new DystPair__getReservesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_getReserves(): ethereum.CallResult<DystPair__getReservesResult> {
    let result = super.tryCall(
      "getReserves",
      "getReserves():(uint112,uint112,uint32)",
      []
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new DystPair__getReservesResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
  ...
  lastObservation(): DystPair__lastObservationResultValue0Struct {
    let result = super.call(
      "lastObservation",
    ...
    return changetype<DystPair__lastObservationResultValue0Struct>(
      result[0].toTuple()
    );
  }

  try_lastObservation(): ethereum.CallResult<
    DystPair__lastObservationResultValue0Struct
  > {
    let result = super.tryCall(
      "lastObservation",
      "lastObservation():((uint256,uint256,uint256))",
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      changetype<DystPair__lastObservationResultValue0Struct>(
        value[0].toTuple()
      )
    );
  }

  metadata(): DystPair__metadataResult {
    let result = super.call(
      "metadata",
    ...
    return new DystPair__metadataResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_metadata(): ethereum.CallResult<DystPair__metadataResult> {
    let result = super.tryCall(
      "metadata",
      "metadata():(uint256,uint256,uint256,uint256,bool,address,address)",
      []
  ...
  observations(param0: BigInt): DystPair__observationsResult {
    let result = super.call(
      "observations",
    ...
    return new DystPair__observationsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_observations(
    param0: BigInt
  ): ethereum.CallResult<DystPair__observationsResult> {
    let result = super.tryCall(
      "observations",
      "observations(uint256):(uint256,uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new DystPair__observationsResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
  ...
  tokens(): DystPair__tokensResult {
    let result = super.call("tokens", "tokens():(address,address)", []);

    return new DystPair__tokensResult(
      result[0].toAddress(),
      result[1].toAddress()
    );
  }

  try_tokens(): ethereum.CallResult<DystPair__tokensResult> {
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new DystPair__tokensResult(value[0].toAddress(), value[1].toAddress())
    );
  }
