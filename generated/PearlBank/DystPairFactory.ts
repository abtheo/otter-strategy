...
export class PairCreated__Params {
  ...
  get allPairsLength(): BigInt {
    return this._event.parameters[4].value.toBigInt();
  }
}

export class DystPairFactory__getInitializableResult {
  value0: Address;
  value1: Address;
  value2: boolean;
...
export class DystPairFactory extends ethereum.SmartContract {
  static bind(address: Address): DystPairFactory {
    return new DystPairFactory("DystPairFactory", address);
  }
  ...
  getInitializable(): DystPairFactory__getInitializableResult {
    let result = super.call(
      "getInitializable",
    ...
    return new DystPairFactory__getInitializableResult(
      result[0].toAddress(),
      result[1].toAddress(),
      result[2].toBoolean()
    );
  ...
  try_getInitializable(): ethereum.CallResult<
    DystPairFactory__getInitializableResult
  > {
    let result = super.tryCall(
      "getInitializable",
      "getInitializable():(address,address,bool)",
    ...
    return ethereum.CallResult.fromValue(
      new DystPairFactory__getInitializableResult(
        value[0].toAddress(),
        value[1].toAddress(),
        value[2].toBoolean()
      )
