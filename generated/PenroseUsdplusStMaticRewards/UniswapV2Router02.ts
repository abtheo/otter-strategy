...
export class UniswapV2Router02__addLiquidityResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class UniswapV2Router02__removeLiquidityResult {
  value0: BigInt;
  value1: BigInt;
...
export class UniswapV2Router02__removeLiquidityETHResult {
  value0: BigInt;
  value1: BigInt;
...
export class UniswapV2Router02__removeLiquidityETHWithPermitResult {
  value0: BigInt;
  value1: BigInt;
...
export class UniswapV2Router02__removeLiquidityWithPermitResult {
  value0: BigInt;
  value1: BigInt;
...
export class UniswapV2Router02 extends ethereum.SmartContract {
  static bind(address: Address): UniswapV2Router02 {
    return new UniswapV2Router02("UniswapV2Router02", address);
  }
  ...
  addLiquidity(
    ...
    to: Address,
    deadline: BigInt
  ): UniswapV2Router02__addLiquidityResult {
    ...
    return new UniswapV2Router02__addLiquidityResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_addLiquidity(
    ...
    to: Address,
    deadline: BigInt
  ): ethereum.CallResult<UniswapV2Router02__addLiquidityResult> {
    ...
    return ethereum.CallResult.fromValue(
      new UniswapV2Router02__addLiquidityResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
  ...
  removeLiquidity(
    ...
    to: Address,
    deadline: BigInt
  ): UniswapV2Router02__removeLiquidityResult {
    let result = super.call(
      "removeLiquidity",
    ...
    return new UniswapV2Router02__removeLiquidityResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_removeLiquidity(
    ...
    to: Address,
    deadline: BigInt
  ): ethereum.CallResult<UniswapV2Router02__removeLiquidityResult> {
    let result = super.tryCall(
      "removeLiquidity",
      "removeLiquidity(address,address,uint256,uint256,uint256,address,uint256):(uint256,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new UniswapV2Router02__removeLiquidityResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  removeLiquidityETH(
    ...
    to: Address,
    deadline: BigInt
  ): UniswapV2Router02__removeLiquidityETHResult {
    let result = super.call(
      "removeLiquidityETH",
    ...
    return new UniswapV2Router02__removeLiquidityETHResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_removeLiquidityETH(
    ...
    to: Address,
    deadline: BigInt
  ): ethereum.CallResult<UniswapV2Router02__removeLiquidityETHResult> {
    let result = super.tryCall(
      "removeLiquidityETH",
      "removeLiquidityETH(address,uint256,uint256,uint256,address,uint256):(uint256,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new UniswapV2Router02__removeLiquidityETHResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  removeLiquidityETHWithPermit(
    ...
    r: Bytes,
    s: Bytes
  ): UniswapV2Router02__removeLiquidityETHWithPermitResult {
    let result = super.call(
      "removeLiquidityETHWithPermit",
    ...
    return new UniswapV2Router02__removeLiquidityETHWithPermitResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  > {
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new UniswapV2Router02__removeLiquidityETHWithPermitResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  removeLiquidityWithPermit(
    ...
    r: Bytes,
    s: Bytes
  ): UniswapV2Router02__removeLiquidityWithPermitResult {
    let result = super.call(
      "removeLiquidityWithPermit",
    ...
    return new UniswapV2Router02__removeLiquidityWithPermitResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_removeLiquidityWithPermit(
    ...
    r: Bytes,
    s: Bytes
  ): ethereum.CallResult<UniswapV2Router02__removeLiquidityWithPermitResult> {
    let result = super.tryCall(
      "removeLiquidityWithPermit",
      "removeLiquidityWithPermit(address,address,uint256,uint256,uint256,address,uint256,bool,uint8,bytes32,bytes32):(uint256,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new UniswapV2Router02__removeLiquidityWithPermitResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
