...
export function handleDeposit(deposit: Deposit): void {
    ...
    cumulativeValues.clamPondDepositedAmount = cumulativeValues.clamPondDepositedAmount.plus(toDecimal(deposit.params.amount, 6))
...
export function handleWithdraw(withdraw: Withdraw): void {
    ...
    cumulativeValues.clamPondDepositedAmount = cumulativeValues.clamPondDepositedAmount.minus(toDecimal(withdraw.params.amount, 6))
    metric.clamPondDepositedAmount = cumulativeValues.clamPondDepositedAmount
