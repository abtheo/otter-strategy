...
export function updateTreasuryRevenueHarvest(blockNumber: BigInt, harvest: Harvest): void {
...
export function updateTreasuryRevenueQiTransfer(blockNumber: BigInt, transfer: Transfer): void {
